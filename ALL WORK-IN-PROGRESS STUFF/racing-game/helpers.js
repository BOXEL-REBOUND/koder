...
function drawRotatedImage(image, x, y, angle) {
	...
	// move to the middle of where we want to draw our
	// image
	...
	// and restore the co-ords to how they were when we
	// began
	context.restore();
}
...
function distance(from, to) {
	var a = from.x > to.x ? from.x - to.x : to.x - from.x, b = from.y > to.y ? from.y - to.y : to.y - from.y;
